...
//    System.out.println("C45PrunableClassifierTree.buildClassifier");
//	for (Instance instance : data) 
//		System.out.println(instance.hashCode());
	
    // remove instances with missing class
	// TODO: commented because changes the references of data
//    data = new Instances(data);
    data.deleteWithMissingClass();
    
//    System.out.println("C45PrunableClassifierTree.buildClassifier2");
//	for (Instance instance : data) 
//		System.out.println(instance.hashCode());
    
//   System.out.println("C45PruneableClassifierTree # buildClassifier calls buildTree(Instance, boolean) -- data.numInstances() " + data.numInstances());
  ...
  public void prune() throws Exception {
    ...
    if (!m_isLeaf) {
      ...
      if (Utils.smOrEq(errorsLeaf,errorsTree+0.1) && Utils.smOrEq(errorsLeaf,errorsLargestBranch+0.1)) {
    	  System.out.println("\tleaf is best choice");
      ...
      if (Utils.smOrEq(errorsLargestBranch,errorsTree+0.1)) {
    	  System.out.println("\tlargest branch is better choice than whole subtree"); 
    	  System.out.println("m_train.size()=" + m_train.size());
    	  System.out.println("\t\t old ==> " + m_localModel.m_splitRelation.getRelationName());
    	  largestBranch = son(indexOfLargestBranch);
    	  m_sons = largestBranch.m_sons;
    	  m_localModel = largestBranch.localModel();
    	  System.out.println("\t\t new ==> " + m_localModel.m_splitRelation.getRelationName());
