...
public class MetricOverlapsLE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 8528154840610753690L;

	public MetricOverlapsLE() {
		m_relationName = "MetricOverlapsLE";
	}
