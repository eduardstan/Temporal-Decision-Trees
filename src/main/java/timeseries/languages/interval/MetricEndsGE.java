...
public class MetricEndsGE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = -196908123330587579L;

	public MetricEndsGE() {
		m_relationName = "MetricEndsGE";
	}
