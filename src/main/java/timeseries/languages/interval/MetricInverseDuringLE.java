...
public class MetricInverseDuringLE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 4359060307104073557L;

	public MetricInverseDuringLE() {
		m_relationName = "MetricInverseDuringLE";
	}
