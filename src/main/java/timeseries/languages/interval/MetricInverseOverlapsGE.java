...
public class MetricInverseOverlapsGE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 3223844218090417960L;

	public MetricInverseOverlapsGE() {
		m_relationName = "MetricInverseOverlapsGE";
	}
