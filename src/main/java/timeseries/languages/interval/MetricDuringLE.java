...
public class MetricDuringLE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 7359762077518139994L;

	public MetricDuringLE() {
		m_relationName = "MetricDuringLE";
	}
