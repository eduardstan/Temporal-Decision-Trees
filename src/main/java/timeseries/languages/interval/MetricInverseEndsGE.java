...
public class MetricInverseEndsGE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = -1285408452288588830L;

	public MetricInverseEndsGE() {
		m_relationName = "MetricInverseEndsGE";
	}
