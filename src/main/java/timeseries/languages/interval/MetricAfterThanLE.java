...
public class MetricAfterThanLE extends MetricIntervalRelation implements Serializable {
	

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 5671305131490021569L;

	public MetricAfterThanLE() {
		m_relationName = "MetricAfterThanLE";
	}
	
	@Override
	public String existentialRelation() {
		return "<A len <= " + getIntervalLength() + ">";
	}
