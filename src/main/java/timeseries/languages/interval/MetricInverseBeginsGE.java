...
public class MetricInverseBeginsGE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = -969116877779956150L;

	public MetricInverseBeginsGE() {
		m_relationName = "MetricInverseBeginsGE";
	}
