...
public class MetricInverseLaterThanGE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = -8191236562442638978L;

	public MetricInverseLaterThanGE() {
		m_relationName = "MetricInverseLaterThanGE";
	}
