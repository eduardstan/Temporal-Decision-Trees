...
public class MetricLaterThanGE extends MetricIntervalRelation implements Serializable {

	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 7485342140109119118L;
	
	public MetricLaterThanGE() {
		m_relationName = "MetricLaterThanGE";
	}
