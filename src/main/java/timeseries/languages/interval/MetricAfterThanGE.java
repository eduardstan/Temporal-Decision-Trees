...
public class MetricAfterThanGE extends MetricIntervalRelation implements Serializable {
	
	/**
	 * For serialization.
	 */
	private static final long serialVersionUID = 7388650229916598697L;

	public MetricAfterThanGE() {
		m_relationName = "MetricAfterThanGE";
	}
